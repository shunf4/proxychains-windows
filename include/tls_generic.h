...
#define PXCH_TLS_OFFSET_LOG_TIME (PXCH_TLS_OFFSET_W32HOSTENT_HOSTNAME_BUF + sizeof(char[PXCH_MAXHOSTNAME_BUFSIZE]))
#define PXCH_TLS_OFFSET_LOG_SZLOGLINE (PXCH_TLS_OFFSET_LOG_TIME + g_dwW32SystemTimeSize)
#define PXCH_TLS_OFFSET_LOG_MSG (PXCH_TLS_OFFSET_LOG_SZLOGLINE + sizeof(wchar_t[PXCH_MAXFWPRINTF_BUFSIZE]))
...
#define PXCH_TLS_TOTAL_SIZE (PXCH_TLS_OFFSET_DUMP_MEMORY_BUF + sizeof(wchar_t[PXCH_MAXDUMP_MEMORY_BUFSIZE]))
