...
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.exe" ..\proxychains.exe.sln /build "Release^|x64"
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.exe" ..\proxychains.exe.sln /build "Release^|x86"
