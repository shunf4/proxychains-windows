...
copy %cd%\..\win32_output\proxychains_helper_x64.exe %USERPROFILE%\bin\ || pause
copy %cd%\..\win32_output\proxychains_helper_x86.exe %USERPROFILE%\bin\ || pause
...
copy %cd%\..\win32_output\proxychains_helper_x64d.exe %USERPROFILE%\bin\ || pause
copy %cd%\..\win32_output\proxychains_helper_x86d.exe %USERPROFILE%\bin\ || pause
